<template>
  <div
    class="w-full h-screen flex flex-row overflow-hidden bg-[url('../assets/background_pattern.png')] bg-blue-100 bg-repeat"
  >
    <div class="w-full flex justify-center items-center">
      <div>
        <div>
          ...
          >
            <img src="../assets/ghost.png" alt="profile" class="w-12 h-12" />
            <div>
              <div class="text- text-xl font-bold">Ghost AI</div>
              <div class="text- text-base">Real you, unreal interactions</div>
            </div>
          </div>
          <div class="py-3">
            <!-- <button
            ...
            <v-btn
              ...
              elevation="0"
            >
              <v-icon left class="pr-3">mdi-github</v-icon>
          ...
          <!-- <div class="text-lg">Sign in to your account to continue</div> -->
        </div>
      </div>
    </div>
    <div class="w-full h-full flex justify-end overflow-hidden">
      <img
        src="../assets/8380977729351e94802f6f87df1feac2_high.webp"
        alt="login"
      />
    </div>
    <!-- <div></div> -->
